...
ROUTES = {
  ...
  'in affected ear': ['by ear', 'otically', 'otic', r'(?:in to |into |in |to |per )?(?:the )?affected ear\b'],
  ...
  'under the skin': ['subcutaneously', 'subcutaneous', r'(?:into|in|under) (?:the )?skin', r'sub(?: |-)*cutaneous(?:ly)?', r'subq\b', r'sub\.q\.', r'sc\b', r'subcu\b', r's\.c\.', r'sq\b', r's\.q\.'],
  ...
  'between the cheek and gums': ['buccally', r'between (?:the )?cheek and (?:the )?gums', 'buccal'],
...
DOSE_UNITS = {
  ...
  # drops
  'drop': [r'drops', r'gtt'],
  'oral drop': [r'oral drops'],
  'eye/ear drop': [r'eye/ear drops'],
  'eye drop': [r'eye drops', r'ophthalmic drop'],
  'prolonged-release eye drop': [r'(?:prolonged-release|prolonged release) eye drops'],
  'nasal drop': [r'nasal drops', r'nose drop'],
  'eye/ear/nose drop': [r'eye/ear/nose drops'],
  'ear drop': [r'ear drops', r'otic drop'],
  'modified release drop': [r'modified release drops', r'modified-release drop'],
  # spray
  'spray': [],
  'oromucosal spray': [],
  'sublingual spray': [],
