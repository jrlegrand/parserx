...
class SigParsedSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SigParsed
        fields = ['id', 'sig_text', 'created', 'version', 'method', 'dose', 'dose_max', 'dose_unit', 'strength', 'strength_max', 'strength_unit', 'route', 'frequency', 'frequency_max', 'period', 'period_max', 'period_unit', 'time_duration', 'time_duration_unit', 'day_of_week', 'time_of_day', 'when', 'offset', 'bounds', 'count', 'frequency_readable', 'duration', 'duration_max', 'duration_unit', 'as_needed', 'indication', 'sig_reviewed', 'sig_reviewed_status'
        ,'method_text', 'method_text_start', 'method_text_end', 'dose_text', 'dose_text_start', 'dose_text_end', 'strength_text', 'strength_text_start', 'strength_text_end', 'route_text', 'route_text_start', 'route_text_end', 'frequency_text', 'frequency_text_start', 'frequency_text_end', 'when_text', 'when_text_start', 'when_text_end', 'duration_text', 'duration_text_start', 'duration_text_end', 'indication_text', 'indication_text_start', 'indication_text_end']
